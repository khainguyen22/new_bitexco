...
if (!function_exists('theme_enqueue_styles')) {
...

    {
        ...
        // wp_enqueue_script('lightgallery-min', get_template_directory_uri() . '/access/js/lightgallery.min.js', array('jquery'), null, false);
...
function my_scripts()
{
    ...
    wp_enqueue_script('magnific-popup-min', get_template_directory_uri() . '/access/js/magnific-popup.min.js', array('jquery'), null, false);
