                    ...
                    <div class="article-container">
                        <article>
                            ...
                            <?php if (get_field('file')) : ?>
                                <div class="attach">
                                    <div class="attach-title d-flex">
                                        ...
                                        <span><?php _e('Đính kèm:'); ?></span>
                                    </div>
                                    <?php foreach (get_field('file') as $value) : ?>
                            ...
                            <a class="back" href="">
                                ...
                                <span onclick="window.history.go(-1); return false;"><?php _e('Quay lại'); ?></span>
                            </a>
                        </article>
                    </div>
                </section>
