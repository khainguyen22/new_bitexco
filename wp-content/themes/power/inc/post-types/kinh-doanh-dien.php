<?php
function register_post_type_electricity_business()
{

    $labels = array(
        'name'                  => _x('Kinh doanh điện', 'Post Type General Name', 'shtheme'),
        'singular_name'         => _x('Kinh doanh điện', 'Post Type Singular Name', 'shtheme'),
        'menu_name'             => __('Kinh doanh điện', 'shtheme'),
        'name_admin_bar'        => __('Kinh doanh điện', 'shtheme'),
        'archives'              => __('Item Archives', 'shtheme'),
        'attributes'            => __('Item Attributes', 'shtheme'),
        'parent_item_colon'     => __('Parent Item:', 'shtheme'),
        'all_items'             => __('Tất cả Kinh doanh điện', 'shtheme'),
        'add_new_item'          => __('Thêm Kinh doanh điện', 'shtheme'),
        'add_new'               => __('Thêm Kinh doanh điện', 'shtheme'),
    ...
    $rewrite = array(
        'slug'                  => 'electricity_business',
        'with_front'            => true,
        'pages'                 => true,
        'feeds'                 => true,
    );
    $args = array(
        'label'                 => __('Kinh doanh điện', 'shtheme'),
    ...
    register_post_type('electricity_business', $args);
}
add_action('init', 'register_post_type_electricity_business', 0);
