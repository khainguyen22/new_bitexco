<?php
function register_post_type_shareholders()
{

    $labels = array(
        'name'                  => _x('Cổ Đông', 'Post Type General Name', 'shtheme'),
        'singular_name'         => _x('Cổ Đông', 'Post Type Singular Name', 'shtheme'),
        'menu_name'             => __('Cổ Đông', 'shtheme'),
        'name_admin_bar'        => __('Cổ Đông', 'shtheme'),
        'archives'              => __('Item Archives', 'shtheme'),
        'attributes'            => __('Item Attributes', 'shtheme'),
        'parent_item_colon'     => __('Parent Item:', 'shtheme'),
        'all_items'             => __('Tất cả Cổ Đông', 'shtheme'),
        'add_new_item'          => __('Thêm Cổ Đông', 'shtheme'),
        'add_new'               => __('Thêm Cổ Đông', 'shtheme'),
...
add_action('init', 'register_post_type_shareholders', 0);