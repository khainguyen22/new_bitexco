 ...
 */
function specia_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function specia_sanitize_css( $css ) {
 ...
 */
function specia_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function specia_sanitize_email( $email, $setting ) {
 ...
 */
function specia_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function specia_sanitize_html( $html ) {
 ...
 */
function specia_sanitize_image( $image, $setting ) {
 ...
 */
function specia_sanitize_nohtml( $nohtml ) {
 ...
 */
function specia_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function specia_sanitize_number_range( $number, $setting ) {
 ...
 */
function specia_sanitize_select( $input, $setting ) {
 ...
 */
function specia_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function specia_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function specia_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}