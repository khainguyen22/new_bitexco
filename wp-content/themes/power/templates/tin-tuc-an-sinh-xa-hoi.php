...
/**
Template Name: Tin tức an sinh xã hội
 **/
$tin_tuc_an_sinh_xa_hoi = get_field('tin_tuc_an_sinh_xa_hoi', 'option');
$other_info = $tin_tuc_an_sinh_xa_hoi['other_info'];
$args = array(
                ...
                <div class="form-filter ">
                    <div class="form d-flex justify-content-between">
                        ...
                        <div class="button-submit">
                            <button class="btn btn-search btn-submit btn-social_security">Tìm kiếm</button>
                        </div>
