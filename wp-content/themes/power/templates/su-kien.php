                ...
                <div class="small-form-filter form-filter">
                    <div class="form">
                        ...
                        <div class="button-submit">
                            <button type="submit" class="btn btn-search btn-submit"><?php _e('Tìm kiếm') ?></button>
                        </div>
                        <div class="button-reset">
                            <button class="btn btn-search btn-reset"><?php _e('Đặt lại') ?></button>
                        </div>
                    </div>
                </div>
