                                                        ...
                                                        <div class="card-body content">
                                                            ...
                                                            <?php if ($value['item']['phone']) : ?>
                                                                ...
                                                                <span class="d-flex phone flex-wrap">
                                                                    ...
                                                                    <?php foreach ($value['item']['phone'] as $key => $phone) : ?>
                                                                        ...
                                                                        <div><a href="tel:<?php echo formatPhoneNumber($phone['item']) ?>"> <?php echo formatPhoneNumber($phone['item']) ?></a></div>
                                                            ...
                                                            <?php if ($value['item']['fax']) : ?>
                                                                ...
                                                                <span class="d-flex fax">
                                                                    ...
                                                                    <span>Fax: <a href="tel:<?php echo formatPhoneNumber($value['item']['fax']) ?>"> <?php echo formatPhoneNumber($value['item']['fax']); ?></a></span>
