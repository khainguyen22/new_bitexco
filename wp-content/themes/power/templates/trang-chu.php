                ...
                <?php if ($home_tin_tuc_moi) : ?>
                    ...
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <?php if ($home_tin_tuc_moi_title_content) : ?> <h3 class="title"><?php echo _e($home_tin_tuc_moi_title_content)   ?></h3> <?php endif; ?>

                            <?php if ($home_tin_tuc_moi_desc_content) : ?> <p class="desc size-text-16"><?php echo _e($home_tin_tuc_moi_desc_content)   ?></p> <?php endif; ?>

                            <?php if ($home_tin_tuc_moi_button) : ?><a href="<?php echo $home_tin_tuc_moi_link ?>" class="btn btn-warning btn-detail uppercase"><?php echo ($home_tin_tuc_moi_button) ? $home_tin_tuc_moi_button : "Chi tiết"; ?></a><?php endif; ?>
                ...
                <?php if ($home_tuyen_dung) : ?>
                    ...
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <?php if ($home_tuyen_dung_button) : ?> <a href="<?php echo $home_tuyen_dung_link ?>" class="btn btn-warning btn-detail uppercase"><?php echo ($home_tuyen_dung_button) ? $home_tuyen_dung_button : "Chi tiết"; ?></a><?php endif; ?>
