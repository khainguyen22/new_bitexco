        ...
        <section class="banner list" style='background-image:url("<?php echo $banner['background']; ?>")'>
            ...
            <div class="container">
                ...
                <div class="content">
                    ...
                    <?php if ($banner['title']) : ?><h3><?php echo paint_if_exist($banner['title']) ?></h3>
                    <?php endif; ?>

                    <?php if ($banner['description']) : ?> <p><?php echo paint_if_exist($banner['description']); ?></p>
                    <?php endif; ?>
                ...
                <div class="navigation">
                    ...
                    <ul>
                        ...
                        <li class="<?php echo $key == 0 ? 'active' : '' ?>"> <a
                                href="<?php echo $value['link']; ?>"><?php echo paint_if_exist($value['label']); ?></a>
                        </li>
            ...
            <div class="container">
                        ...
                        <div class="col-12 col-lg-6 tin-noi-bat animate_underline  ">
                            ...
                            <div class="content">
                                ...
                                <span class="tag tag-name"><span
                                        class="text"><?php echo get_the_tag_list('', ', ') ?></span> </span>
                            ...
                            <div class="row tin-moi-nhat">
                                ...
                                <div class="col-12 d-flex tin-moi-nhat-item ">
                                    ...
                                    <div class="content">
                                        ...
                                        <h6><a href="<?php echo get_the_permalink() ?>"><?php echo the_title() ?></a>
                                        </h6>

                                        <span class="tag tag-name"><span
                                                class="text"><?php echo get_the_tag_list('', ', ') ?></span>
                ...
                <div class="navigation">
                    ...
                    <ul class="d-flex">
                        ...
                        <li class="<?php echo $actual_link == $value['link'] ? 'active' : '' ?>"> <a
                                href="<?php echo $value['link']; ?>"><?php echo paint_if_exist($value['label']); ?></a>
                        </li>
                        ...
                        <div class="form d-flex justify-content-between">
                            ...
                            <div class="form-filter-search d-flex">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    <circle cx="11" cy="11" r="8" stroke="#7E8189" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round"></circle>

                                    <path d="M16.5 16.958L21.5 21.958" stroke="#7E8189" stroke-width="1.5"
                            ...
                            <div class="form-filter-company filter-item form-filter-field">
                                ...
                                <ul>
                                    ...
                                    <li class="item active default first">
                                        <?php echo paint_if_exist($tax_post_company_news) ?></li>

                                    <?php endif ?>

                                    <?php foreach ($terms as $key => $value) : ?>

                                    <li class="item" data-value="<?php echo $value->slug ?>">
                                        <?php echo paint_if_exist($value->name) ?></li>
                            ...
                            <div class="form-filter-type filter-item">
                                ...
                                <ul>
                                    ...
                                    <li class="item active default first">
                                        <?php echo paint_if_exist($tax_post_type_news) ?></li>
                            ...
                            <div class="form-filter-date d-flex">
                                ...
                                <input placeholder="Thời gian" name="date" class="textbox-n" type="text"
                                    onclick="(this.type='date')" id="date">

                                <svg width="20" height="22" viewBox="0 0 20 22" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">

                                    <path
                                        d="M1 6C1 4.34315 2.34315 3 4 3H16C17.6569 3 19 4.34315 19 6V18C19 19.6569 17.6569 21 16 21H4C2.34315 21 1 19.6569 1 18V6Z"
                                        stroke="#2B3F6C" stroke-width="1.5" />

                                    <path d="M1 8H19" stroke="#2B3F6C" stroke-width="1.5" stroke-linejoin="round" />

                                    <path d="M14.5 1.5L14.5 4.5" stroke="#2B3F6C" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />

                                    <path d="M5.5 1.5L5.5 4.5" stroke="#2B3F6C" stroke-width="1.5"
                                        stroke-linecap="round" stroke-linejoin="round" />

                                    <path d="M4.5 12H5.5" stroke="#2B3F6C" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />

                                    <path d="M9.5 12H10.5" stroke="#2B3F6C" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />

                                    <path d="M14.5 12H15.5" stroke="#2B3F6C" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />

                                    <path d="M4.5 16H5.5" stroke="#2B3F6C" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />

                                    <path d="M9.5 16H10.5" stroke="#2B3F6C" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />

                                    <path d="M14.5 16H15.5" stroke="#2B3F6C" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                ...
                <div class="list">
                    ...
                    <div class="custom-post d-flex ">
                        ...
                        <div class="content ">
                            ...
                            <?php if (get_the_tag_list()) : ?><span class="tag tag-name"><span
                                    class="text"><?php echo get_the_tag_list('', ', ') ?></span> </span><?php endif; ?>

                            <h6> <a href="<?php echo get_the_permalink() ?>"><?php echo the_title() ?></a></h6>

                            <?php if (get_the_excerpt()) : ?><p class="size-text-16"><?php echo get_the_excerpt() ?></p>
                            <?php endif; ?>
        ...
        <section class="other-information">
            ...
            <div class="other-container">
                ...
                <div class="other-content hover-zoom">
                    ...
                    <a href="<?php echo $value['link']; ?>" class="hydro-electric-news"
                        style="background-image:url('<?php echo $value['image']; ?>')"><span
                            class="text"><?php echo paint_if_exist($value['text']); ?></span> </a>
