...
Template Name: Danh mục dự án - Dự án đang xây dựng
...
<div class="du-an-dang-xay-dung du-an">
    ...
    <section class="du-an-head">
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <?php if ($du_an_dang_xay_dung['title']) : ?><h3 class="justify-content-center"><?php echo $du_an_dang_xay_dung['title']; ?></h3><?php endif; ?>

                <?php if ($du_an_dang_xay_dung['description']) : ?><p><?php echo $du_an_dang_xay_dung['description']; ?></p><?php endif; ?>
