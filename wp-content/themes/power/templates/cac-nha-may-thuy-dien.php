...
Template Name: Các nhà máy thủy điện
...
$banner = get_field('banner_cac_nha_may_thuy_dien', 'option');

$other_info = get_field('other_info_cac_nha_may_thuy_dien', 'option');
...
<div class="du-an cac-nha-may-thuy-dien">
    ...
    <section class="banner list" style='background-image:url("<?php echo $banner['background']; ?>")'>
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <?php if ($banner['title']) : ?><h3 class="justify-content-center"><?php echo $banner['title']; ?></h3> <?php endif; ?>
            ...
            <div class="small-form-filter">
                ...
                <div class="form">
                    ...
                    <div class="form-filter-area filter-item">
                        ...
                        <ul>
                            ...
                            <?php if (isset($tax_project_location)) : ?>
                                ...
                                <li class="item default active first"><?php echo paint_if_exist($tax_project_location) ?></li>
                    ...
                    <div class="form-filter-company filter-item">
                        ...
                        <ul class="">
                            <?php if (isset($tax_project_company)) : ?>
                                <li class="item default active first"><?php echo paint_if_exist($tax_project_company) ?></li>
                            <?php endif ?>
