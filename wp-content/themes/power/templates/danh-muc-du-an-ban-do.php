        ...
        function myMap() {
            ...
            <?php if ($query->have_posts()) : ?>
                ...
                <?php while ($query->have_posts()) : $query->the_post() ?>
                    ...
                    locationInfo += '<p><strong>Công ty: </strong>Công ty CP Đầu tư & Phát triển điện Nho Quế</p>';
                    ...
                    locationInfo += '<p><strong>Loại hình: </strong>Thủy điện</p>';
                    ...
                    locationInfo += '<p><strong>Thời điểm COD: </strong>2016</p>';
                    ...
                    locationInfo += '<p><strong>Tình trạng: </strong>Đang vận hành</p>';
                    ...
                    locationInfo += '<p><strong>Công suất lắp máy: </strong>48 MW</p>';
                    ...
                    locationInfo += '<p><strong>Sản lượng thiết kế: </strong>195.45 triệu kWh/năm</p>';
                    ...
                    locationInfo += '<p><strong>Địa chỉ: </strong>Giàng Chu Phìn, Mèo Vạc, Hà Giang</p>';
                    ...
                    locationInfo += '<a href="#" class="btn  btn-detail">Xem chi tiết</a>';

                    locationInfo += '<a href="#" class="btn btn-close" id="btn-close">Đóng</a>';
