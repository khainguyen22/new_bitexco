        ...
        function myMap() {
            ...
            <?php if ($query->have_posts()) : ?>
                <?php while ($query->have_posts()) : $query->the_post() ?>
                    ...
                    locationInfo += '<img src="<?php echo get_field('icon', get_the_ID()) ?>" alt="<?php echo the_title() ?>">';
                    locationInfo += '</div>'
                    ...
                    locationInfo += '<p><strong>Loại hình: </strong><?php foreach (get_the_terms(get_the_ID(), 'project_type') as $value) {
                                                                        echo $value->name;
                                                                    } ?></p>';
                    locationInfo += '</div>';
                    locationInfo += '<div class="d-flex location-info-row">';
                    ...
                    locationInfo += '<p><strong>Tình trạng: </strong><?php foreach (get_the_terms(get_the_ID(), 'type_projects') as $value) {
                                                                            echo $value->name;
                                                                        } ?></p>';
                    locationInfo += '</div>';
                    locationInfo += '<div class="d-flex location-info-row">';
