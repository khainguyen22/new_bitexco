...
/**
Template Name: Danh mục dự án - Dự án đang vận hành
 **/
...
get_header();
?>
<div class="du-an-dang-van-hanh du-an">
	...
	<section class="du-an-head">
		<div class="container">
			<div class="content">
				<?php if ($du_an_dang_van_hanh['title']) : ?><h3 class="justify-content-center"><?php echo $du_an_dang_van_hanh['title']; ?></h3><?php endif; ?>
				<?php if ($du_an_dang_van_hanh['description']) : ?><p><?php echo $du_an_dang_van_hanh['description']; ?></p><?php endif; ?>
			</div>
		</div>
	</section>
