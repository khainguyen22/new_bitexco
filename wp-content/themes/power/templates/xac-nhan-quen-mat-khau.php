...
/**
 * Template Name: Xác nhận quên mật khẩu
 */
?>
<!DOCTYPE html>
...
<body>
    <section class="register access-forgot-password">
        <div class="register-box">
            <div class="form-box">
                <div class="login-logo-box logo">
                    <a href="<?php echo get_home_url(); ?>"> <img src="<?php echo get_stylesheet_directory_uri() ?>/access/images/logo.png" alt="logo" width="49px" height="67px"></a>
                </div>
                <div class="languages">
                ...
                <div class="title">
                    <h2 class="forget-password-title">Email đã được gửi</h2>
                </div>
                <div class="form">
                    <form action="">
                        <div class="reset-password-notifition">
                            <p>Hướng dẫn đặt lại mật khẩu đã được gửi đến địa chỉ email đăng ký của bạn</p>
                        </div>
                        <div class="submit">
                            <button class="btn btn-search register-btn custom-btn">Đăng nhập lại</button>
                        </div>
                    </form>
                </div>
            </div>
