...
$the_query_filter = new WP_Query($filter);
...
<div class="company_member">
    ...
    <section class="banner list not_navigation" style='background-image:url("<?php echo $banner['background']; ?>")'>
            ...
            <div class="small-form-filter">
                ...
                <div class="form">
                    ...
                    <div class="form-filter-area filter-item">
                        ...
                        $tax_location_company_member = get_taxonomy('location_company_member')->label;
                        ...
                        <?php if (isset($tax_location_company_member)) : ?>



                            <span class="item-default"><?php echo paint_if_exist($tax_location_company_member) ?></span>
                        ...
                        <ul>
                            ...
                            <?php if (isset($tax_location_company_member)) : ?>
                                ...
                                <li class="item active default first"><?php echo paint_if_exist($tax_location_company_member) ?></li>
                        ...
                        <div class="filter-item">
                            ...
                            <div class="item-content">
                                ...
                                <div class="filter-phone item d-flex">
                                    ...
                                    <?php if (get_field("phone")) : ?><p><a href="tel:+<?php echo get_field("phone"); ?>"><?php echo formatPhoneNumber(get_field("phone")); ?></a></p><?php endif; ?>
