...
$gia_tri_dem_lai_cho_khach_hang = get_field('gia_tri_dem_lai_cho_khach_hang', 'option');
$gia_tri_dem_lai_cho_khach_hang_banner = '';
$gia_tri_dem_lai_cho_khach_hang_tab_content = '';
if ($gia_tri_dem_lai_cho_khach_hang) {
  $gia_tri_dem_lai_cho_khach_hang_banner = $gia_tri_dem_lai_cho_khach_hang['banner'];
  $gia_tri_dem_lai_cho_khach_hang_tab_content = $gia_tri_dem_lai_cho_khach_hang['tab_content'];
}
    ...
    <section class="your-privilege power-enviroment value-for-customers">
      <div class="container">
        <div class="your-privilege-content">
          <div class="content">
            <span class="divider"></span>
            <h3><?php echo isset($gia_tri_dem_lai_cho_khach_hang_banner['title']) ? $gia_tri_dem_lai_cho_khach_hang_banner['title'] : ""; ?></h3>
            <p><?php echo isset($gia_tri_dem_lai_cho_khach_hang_banner['description']) ? $gia_tri_dem_lai_cho_khach_hang_banner['description'] : ""; ?></p>
          </div>
          <div class="values">
            <div class="the-values">
              <?php if ($gia_tri_dem_lai_cho_khach_hang_tab_content['item']) : ?>
                <?php foreach ($gia_tri_dem_lai_cho_khach_hang_tab_content['item'] as $key => $value) : ?>
    ...
    <section class="your-privilege contact-section">
      <div class="container">
        <div class="your-privilege-content contact-section-content">
          <div class="content">
            <span class="divider"></span>
            <?php if ($lien_he_de_duoc_ho_tro['title']) : ?> <h3><?php echo isset($lien_he_de_duoc_ho_tro['title']) ? $lien_he_de_duoc_ho_tro['title'] : ""; ?></h3>          <?php endif; ?>
          </div>
          <div class="cwt-content">
            ...
            <div class="cwu-content-text">
              <?php if ($lien_he_de_duoc_ho_tro_content['title']) : ?> <h5><?php echo isset($lien_he_de_duoc_ho_tro_content['title']) ? $lien_he_de_duoc_ho_tro_content['title'] : ""; ?></h5> <?php endif; ?>
              <?php if ($lien_he_de_duoc_ho_tro_content['address']) : ?> <div class="address contact-info">
              ...
              <?php if ($lien_he_de_duoc_ho_tro_content['phone']) : ?> <div class="phone-number contact-info">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <?php if ($lien_he_de_duoc_ho_tro_content['fax']) : ?> <div class="contact-info fax">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <?php if ($lien_he_de_duoc_ho_tro_content['email']) : ?> <div class="contact-info email">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
