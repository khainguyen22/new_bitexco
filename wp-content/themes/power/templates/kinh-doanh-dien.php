...
/**
 * Template Name: Kinh Doanh Điện
 */
$tong_quan_dich_vu = get_field('tong_quan_kinh_doanh_dien', 'option');
...
$gia_trị_dem_lại_cho_khach_hang = get_field('value_for_customer', 'option');
...
$lien_he_de_duoc_ho_tro = get_field('kinh_doanh_dien_contact', 'option');
...
get_header();
?>
<div class="tuyen-dung dich-vu kinh-doanh-dien">
  <!-- Banner -->
  <?php
  $banner = get_field('banner_kinh_doanh_dien', 'option');
  ?>
  ...
  <div class="main-content">
    ...
    <?php
    $cuoc_song_tai_bitexco_power = get_field('electricity_business_term', 'option');

    $args = array(
      'post_type'    => 'electricity_business',
    );
    $the_query_post = new WP_Query($args);

    ?>
    <section class="your-privilege life-at-bitexco-section electricity-business">
      <div class="container">
        <div class="your-privilege-content">
          <div class="content">
            <span class="divider"></span>
          ...
          <div class="life-in-bitexco-content">
            <?php if ($the_query_post->have_posts()) : ?>
              <?php while ($the_query_post->have_posts()) : $the_query_post->the_post();
                ...
                <div class="content-item" data-post_ID="<?php echo get_the_ID()?>">
                  <div class="image">
          ...
          <div class="cwt-content">
            ...
            <div class="cwu-content-text">
              ...
              <div class="phone-number contact-info">
                ...
                <?php if ($lien_he_de_duoc_ho_tro_content['phone']) : ?>
                  ...
                  <?php foreach ($lien_he_de_duoc_ho_tro_content['phone'] as $key => $value) : ?>
                    <a href="tel:+<?php echo $value['item']; ?>"><?php echo $value['item']; ?></a><span class="phone-divider"></span>
                  <?php endforeach; ?>
                <?php endif; ?>
                </p>
              </div>
              <div class="contact-info fax">
                ...
                <a href="tel:+<?php echo isset($lien_he_de_duoc_ho_tro_content['fax']) ? $lien_he_de_duoc_ho_tro_content['fax'] : ""; ?>">Fax: + <?php echo isset($lien_he_de_duoc_ho_tro_content['fax']) ? $lien_he_de_duoc_ho_tro_content['fax'] : ""; ?> </a>
              </div>
  ...
  <!-- Other Infor -->
  <?php
  $other_info = get_field('other_info_kinh_doanh_dien', 'option');
  ?>
